...
import ivg.cn.core.util.FeatureCodec;

import java.lang.reflect.Field;
import java.util.HashMap;
import java.util.Map;

import static ivg.cn.core.util.GaReflectUtils.*;
import static ivg.cn.core.util.GaStringUtils.newString;
...
public class Configure {
    ...
    private String targetIp = "127.0.0.1";                // 目标主机IP
    private int targetPort = 6530;                 // 目标进程号
